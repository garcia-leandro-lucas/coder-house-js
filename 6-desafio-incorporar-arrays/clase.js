...
class Producto {
	constructor(id, marca, titulo, descripcion_corta, descripcion_larga, precio, categoria, genero, talle, color) {
		this.id = -1;
		this.marca = marca;
		this.titulo = titulo;
